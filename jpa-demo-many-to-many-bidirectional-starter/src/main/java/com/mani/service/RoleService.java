...
public class RoleService {
	 ...
	 * if(roleRepository.findById(id).isPresent()){ roleRepository.deleteById(id);
	 * if(roleRepository.findById(id).isPresent()){ return
	 * ResponseEntity.unprocessableEntity().
	 * body("Failed to delete the specified record"); } else return
	 * ResponseEntity.ok().body("Successfully deleted specified record"); } else
